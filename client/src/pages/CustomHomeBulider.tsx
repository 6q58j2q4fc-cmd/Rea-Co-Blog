...
/**
 * Custom Home Bulider - Misspelling Landing Page
 * Targets the common misspelling "bulider" instead of "builder"
 * Provides SEO value for typo searches
 */

export default function CustomHomeBulider() {
  return (
    <div className="min-h-screen">
      <PageSEO
        title="Custom Home Bulider Bend Oregon | Award-Winning Builder | Rea Co Homes"
        description="Award-winning custom home bulider in Bend, Oregon. Kevin Rea builds luxury custom homes in Central Oregon since 1977."
        canonicalUrl="/custom-home-bulider"
