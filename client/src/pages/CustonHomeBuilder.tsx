...
/**
 * Custon Home Builder - Misspelling Landing Page
 * Targets the common misspelling "custon" instead of "custom"
 * Provides SEO value for typo searches
 */

export default function CustonHomeBuilder() {
  return (
    <div className="min-h-screen">
      <PageSEO
        title="Custon Home Builder Bend Oregon | Custom Homes | Rea Co Homes"
        description="Award-winning custon home builder in Bend, Oregon. Kevin Rea builds luxury custom homes in Central Oregon since 1977."
        canonicalUrl="/custon-home-builder"
        keywords={["custon home builder", "custom home builder", "luxury homes"]}
      />
      <AdvancedSEO />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          "@id": "https://bendoregonluxuryhomebuilder.com/custon-home-builder",
          ...
          "alternateName": ["custon home builder", "custom home builder", "luxury home builder"],
